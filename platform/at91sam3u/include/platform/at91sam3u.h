/* at91sam7s.h -- AT91SAM3U hardware definitions
**
** Copyright 2006, Brian Swetland.  All rights reserved.
** See provided LICENSE file or http://frotz.net/LICENSE for details.
*/

#ifndef __PLATFORM_AT91SAM3U_H__ 
#define __PLATFORM_AT91SAM3U_H__

#if !defined(AT91_SAM3U)
#error Unspecified Architecture - AT91SAM3U must be defined
#endif
